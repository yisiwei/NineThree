...
public class DBPubService {
    ...
    //新增优惠促销
    public static SoapObject addStorePromotion(String param) {

        String url = "http://m.93966.net:1210/AnWcfDbPub/DbPubService.svc";
        String soapAction = "http://m.93966.net:1210/DbPubService/StorePromotion_Add";
        String methodName = "StorePromotion_Add";
    ...
    //编辑优惠促销
    public static SoapObject editStorePromotion(String param) {

        String url = "http://m.93966.net:1210/AnWcfDbPub/DbPubService.svc";
        String soapAction = "http://m.93966.net:1210/DbPubService/StorePromotion_Edit";
        String methodName = "StorePromotion_Edit";
    ...
    //查询优惠促销
    public static SoapObject getStorePromotionById(String param) {

        String url = "http://m.93966.net:1210/AnWcfDbPub/DbPubService.svc";
        String soapAction = "http://m.93966.net:1210/DbPubService/GetStorePromotionById";
        String methodName = "GetStorePromotionById";
    ...
    //促销列表
    public static SoapObject getStorePromotionList(String param) {

        String url = "http://m.93966.net:1210/AnWcfDbPub/DbPubService.svc";
        String soapAction = "http://m.93966.net:1210/DbPubService/GetStorePromotionList";
        String methodName = "GetStorePromotionList";
    ...
    //促销关闭
    public static SoapObject closePromotionByOrg(String param) {

        String url = "http://m.93966.net:1210/AnWcfDbPub/DbPubService.svc";
        String soapAction = "http://m.93966.net:1210/DbPubService/ClosePromotionByOrg";
        String methodName = "ClosePromotionByOrg";
    ...
    //促销分享图片列表
    public static SoapObject getShareImgUrlList(String param) {

        String url = "http://m.93966.net:1210/AnWcfDbPub/DbPubService.svc";
        String soapAction = "http://m.93966.net:1210/DbPubService/GetShareImgUrlList";
        String methodName = "GetShareImgUrlList";
